...
class plyclass:
    def __init__(self,path):
        ...
        self._instance = torch.empty(0)

    def cal_sh_color(self,idx):
    ...
    def load_ply( self, instance=False):
        ...
        instances = np.asarray(plydata.elements[0]["instance"])
...
ply_path = "/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting/logs/scene_instance.ply"
ply_path_trans = "/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting/logs/scene_instance_less.ply"
