...
from .utils import ti_sigmoid, ti_sigmoid_with_jacobian, quaternion_rotate,ti_maxplus_with_jacobian
...
class GaussianPoint3D:
    ...
    def project_to_camera_covariance(
        ...
        # print("sigma", Sigma," cov_uv",cov_uv)
        return cov_uv
    ...
    def get_color_with_jacobian_by_ray(
        ...
        r, r_jacobian = SphericalHarmonics(
            self.color_r).evaluate_with_jacobian(d)
        r_normalized, r_normalized_jacobian = ti_maxplus_with_jacobian(r)
        g, g_jacobian = SphericalHarmonics(
            self.color_g).evaluate_with_jacobian(d)
        g_normalized, g_normalized_jacobian = ti_maxplus_with_jacobian(g)
        b, b_jacobian = SphericalHarmonics(
            self.color_b).evaluate_with_jacobian(d)
        b_normalized, b_normalized_jacobian = ti_maxplus_with_jacobian(b)
